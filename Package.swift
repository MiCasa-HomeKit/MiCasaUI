...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/MiCasa-HomeKit/SwiftWebUI.git", .branch("develop")),
    .package(url: "https://github.com/realm/SwiftLint.git", from: "0.40.3")
  ],
  targets: [
    // Targets are the basic building blocks of a package. A target can define a module or a test suite.
    // Targets can depend on other targets in this package, and on products in packages this package depends on.
    .target(name: "MiCasaUI", dependencies: ["MiCasaPlugin", "HAP", "SwiftWebUI"]),
    .testTarget(name: "MiCasaUITests", dependencies: ["MiCasaUI"]),
  ]
)
